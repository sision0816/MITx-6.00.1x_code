# -*- coding: utf-8 -*-
"""
Created on Tue Oct 25 21:56:56 2016
...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        '''
        subCaseLetters = string.ascii_lowercase
        upperCaseLetters = string.ascii_uppercase   
#        for word in self.get_valid_words:
#           for letter in word:
        shifted_dict = {}
        shiftedSubCaseLetters = subCaseLetters [shift:] + subCaseLetters [:shift]
        i = 0
        j = 0
        for ltr in subCaseLetters:
            shifted_dict [ltr] = shiftedSubCaseLetters [i]
            i+=1
            print (shifted_dict )
        shiftedUpperCaseLetters = upperCaseLetters [shift:] + upperCaseLetters [:shift]
        for ltr in upperCaseLetters:
            shifted_dict [ltr] = shiftedUpperCaseLetters [j]
            j+=1
        return shifted_dict
